;;; doom-ayu-space-theme.el --- inspired by doom-ayu-mirage, doom-moonlight, and starbound -*- lexical-binding: t; no-byte-compile: t; -*-

(require 'doom-themes)

;;
(defgroup doom-ayu-space-theme nil
  "Options for the `doom-ayu-space' theme."
  :group 'doom-themes)

(defcustom doom-space-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'doom-space-theme
  :type '(choice integer boolean))

(def-doom-theme doom-ayu-space
  "Inspired by doom-ayu-mirage, doom-moonlight, and starbound"
  ...
  (
   ...
   (-modeline-pad
    (when doom-space-padded-modeline
      (if (integerp doom-space-padded-modeline) doom-space-padded-modeline 4))))
